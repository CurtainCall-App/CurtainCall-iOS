...
public struct ReviewWriteView: View {
    ...
    @Bindable private var store: StoreOf<ReviewWriteFeature>
    ...
    public var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack {
                    LazyImage(url: URL(string: store.showInfo.showImage)) { state in
                    ...
                    ReviewGradeView(grade: $store.grade)
                        .padding(.top, 12)
                    ...
                    Text("작성 완료")
                        ...
                        .onTapGestureRectangle {
                            store.send(.didTappedCreateReview)
                        }
                }
